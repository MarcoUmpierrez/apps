  ...
  template: `
    <div class="w-full max-w-sm">
      ...
      <input
        ...
        class="min-h-11 w-full touch-manipulation border-0 border-b border-[#3a2c1c]/40 bg-transparent px-1 py-3 text-center font-['Caveat',cursive] text-xl text-[#3a2c1c] outline-none focus:border-[#3a3f6b]"
      />
      <button
        type="button"
        (click)="onSubmit()"
